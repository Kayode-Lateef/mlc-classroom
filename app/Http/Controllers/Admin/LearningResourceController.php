...
class LearningResourceController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.learning-resources.index', compact(
            'resources',
            'classes',
            'teachers',
            'subjects',
    ...
    public function create()
    {
        ...
        return view('admin.learning-resources.create', compact('classes'));
    }
    ...
    public function show(LearningResource $resource)
    {
        ...
        return view('admin.learning-resources.show', compact('resource'));
    }
    ...
    public function edit(LearningResource $resource)
    {
        ...
        return view('admin.learning-resources.edit', compact('resource', 'classes'));
    }
