...
class NotificationController extends Controller
{
    ...
    public function index()
    {
        try {
            ...
            return view('admin.notifications.index', compact('classes', 'recentNotifications', 'stats'));
    ...
    public function send(Request $request)
    {
        ...
        $messages = [
            ...
            'notification_type.required' => 'Please select a notification type.',
            'notification_type.in' => 'Invalid notification type selected.',
            'channels.required' => 'Please select at least one notification channel (Email, SMS, or In-App).',
            'channels.array' => 'Invalid channels format.',
            'channels.min' => 'Please select at least one notification channel.',
            'channels.*.in' => 'Invalid notification channel selected.',
            ...
            'user_id.required' => 'Please select a user when sending to an individual.',
    ...
    /**
     * ✅ C-2 FIX: Route through NotificationHelper for consistent email 
     * sending with proper error handling, logging, and adherence to
