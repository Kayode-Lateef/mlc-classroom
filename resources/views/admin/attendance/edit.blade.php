        ...
        <div class="main">
            <div class="container-fluid">
                ...
                <div id="main-content">
                    ...
                    <!-- Edit Form -->
                    <form method="POST" action="{{ route('admin.attendance.update', [$attendanceDate->format('Y-m-d'), $class->id, $schedule->id]) }}">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div style="display: flex; justify-content: space-between; align-items: center;">
                                    <div>
                                        <a href="{{ route('admin.attendance.show', [$attendanceDate->format('Y-m-d'), $class->id, $schedule->id]) }}" class="btn btn-info">
