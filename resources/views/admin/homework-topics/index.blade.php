        ...
        <div class="main">
            <div class="container-fluid">
                ...
                <div class="topics-header">
                    ...
                    <div>
                        <a href="{{ route('admin.homework-topics.create') }}" class="btn btn-primary">
                ...
                <div class="filter-section">
                    <form method="GET" action="{{ route('admin.homework-topics.index') }}">
                        <div class="row">
                            <div class="col-md-4">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <a href="{{ route('admin.homework-topics.index') }}" class="btn btn-secondary">
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <div class="action-buttons">
                                                        <a href="{{ route('admin.homework-topics.edit', $topic->id) }}" 
                                                           class="btn btn-sm btn-warning" 
                                                           title="Edit Topic">
                                                            <i class="ti-pencil"></i>
                                                        </a>
                                                        <form action="{{ route('admin.homework-topics.destroy', $topic->id) }}" 
                                                              method="POST" 
