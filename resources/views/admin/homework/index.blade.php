                ...
                <div id="main-content">
                            ...
                            <div class="filter-card">
                                <form method="GET" action="{{ route('admin.homework.index') }}">
                                    ...
                                    <div class="text-right">
                                        <a href="{{ route('admin.homework.index') }}" class="btn btn-secondary btn-sm">
                    ...
                    <!-- Homework Grid -->
                        ...
                        <div class="homework-grid-row">
                            ...
                            <div class="col-lg-4 col-md-6 homework-card-col mb-4">
                                <div class="panel lobipanel-basic panel-info">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div style="padding: 15px; border-top: 1px solid #e9ecef;">
                                            <a href="{{ route('admin.homework.show', $assignment) }}" class="btn btn-primary btn-sm flex-fill">
                                                <i class="ti-eye"></i> View Details
                                            </a>
                                            <a href="{{ route('admin.homework.edit', $assignment) }}" class="btn btn-success btn-sm">
                                                <i class="ti-pencil-alt"></i>
                                            </a>
                                            @if($assignment->file_path)
                                            <a href="{{ route('admin.homework.download', $assignment) }}" class="btn btn-success btn-sm" title="Download">
