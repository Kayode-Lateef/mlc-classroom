                            ...
                            <div class="resource-card">
                                ...
                                <div class="" style="padding: 15px;">
                                    ...
                                    <div style="display: flex; gap: 8px; padding-top: 12px; border-top: 1px solid #e9ecef;">
                                        <a href="{{ route('admin.resources.show', $resource) }}" class="btn btn-primary btn-sm" style="flex: 1;">
                                            <i class="ti-eye"></i> View
                                        </a>
                                        <a href="{{ route('admin.resources.edit', $resource) }}" class="btn btn-success btn-sm" style="flex: 1;">
                                            <i class="ti-pencil"></i> Edit
                                        </a>
                                        @if($resource->resource_type !== 'video' && $resource->resource_type !== 'link')
                                        <a href="{{ route('admin.resources.download', $resource) }}" class="btn btn-pink btn-sm">
