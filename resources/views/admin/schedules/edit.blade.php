                        ...
                        <div class="page-header">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li><a href="{{ route('admin.schedules.show', $schedule) }}">{{ $schedule->class->name }}</a></li>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-8">
                            <div class="card alert">
                                ...
                                <div class="card-body">
                                    ...
                                    <form method="POST" action="{{ route('admin.schedules.update', $schedule) }}" id="edit-schedule-form">
                                        @csrf
                                        @method('PUT')
                        ...
                        <div class="col-lg-4">
                            ...
                            <div class="card alert">
                                ...
                                <div class="card-body">
                                    <a href="{{ route('admin.schedules.show', $schedule) }}" class="btn btn-info btn-block mb-2">
                                        <i class="ti-eye"></i> View Schedule
                                    </a>
                                    <a href="{{ route('admin.classes.show', $schedule->class) }}" class="btn btn-primary btn-block mb-2">
