                        ...
                        <div class="page-header">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li><a href="{{ route('admin.students.show', $student) }}">{{ $student->full_name }}</a></li>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card alert">
                                <div class="card-body">
                                    <form method="POST" action="{{ route('admin.students.update', $student) }}" enctype="multipart/form-data" id="studentEditForm">
                                        @csrf
                                        @method('PUT')
        ...
        $(document).ready(function() {
            ...
            $('#status').on('change', function() {
                ...
                if (newStatus !== originalStatus && (newStatus === 'graduated' || newStatus === 'withdrawn')) {
                    if (!confirm('Are you sure you want to change the status to ' + newStatus + '? This may affect the student\'s class enrolments.')) {
