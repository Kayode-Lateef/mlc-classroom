...
<body>
    <div class="maintenance-container">
        ...
        <p class="footer-text">
            ...
            <a href="mailto:{{ \App\Models\SystemSetting::get('school_email', 'info@maidstonelearning.co.uk') }}">
                {{ \App\Models\SystemSetting::get('school_email', 'info@maidstonelearning.co.uk') }}
            </a>
        </p>
