        ...
        <div class="main">
            <div class="container-fluid">
                ...
                <div id="main-content">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card alert">
                                ...
                                <div class="card-body">
                                    <form method="GET" action="{{ route('superadmin.attendance.create') }}">
                                        <div class="row">
                                            <div class="col-md-4">
                                        ...
                                        <div class="alert alert-warning">
                                            ...
                                            <br>
                                            <small>Please select a different date or <a href="{{ route('superadmin.schedules.create') }}">create a schedule</a> for this class.</small>
                                        </div>
                                        @endif
                                    </form>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="alert alert-info">
                                    ...
                                    <p class="mb-0">Attendance has already been marked for this session. You can <a href="{{ route('superadmin.attendance.edit', [$selectedDate, $selectedClass->id, $selectedSchedule->id]) }}">edit the existing records</a> or <a href="{{ route('superadmin.attendance.show', [$selectedDate, $selectedClass->id, $selectedSchedule->id]) }}">view the session</a>.</p>
                                </div>
                            </div>
                        </div>
                    @endif
                    ...
                    <!-- Attendance Form -->
                    <form method="POST" action="{{ route('superadmin.attendance.store') }}">
                        @csrf
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="text-right">
                                    <a href="{{ route('superadmin.attendance.index') }}" class="btn btn-secondary">
