                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="quick-actions">
                                <a href="{{ route('superadmin.attendance.daily') }}" class="btn btn-primary">
                                    <i class="ti-calendar"></i> Daily Dashboard
                                </a>
                                <a href="{{ route('superadmin.attendance.create') }}" class="btn btn-success">
                                    <i class="ti-plus"></i> Mark Attendance
                                </a>
                                <a href="{{ route('superadmin.attendance.reports') }}" class="btn btn-info">
                            ...
                            <div class="card alert">
                                ...
                                <div class="card-body">
                                        ...
                                        <table class="table table-hover">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{ route('superadmin.attendance.show', [$record->date, $record->class_id, $record->schedule_id]) }}" 
                                                           class="btn btn-sm btn-info" 
                                                           title="View Session">
                                                            <i class="ti-eye"></i>
                                                        </a>
                                                        <a href="{{ route('superadmin.attendance.edit', [$record->date, $record->class_id, $record->schedule_id]) }}" 
                                    ...
                                    <div class="text-center py-5">
                                        ...
                                        <a href="{{ route('superadmin.attendance.create') }}" class="btn btn-primary">
                                            <i class="ti-plus"></i> Mark Attendance
                                        </a>
                                    </div>
                                    @endif
