                        ...
                        <div class="page-header">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li><a href="{{ route('superadmin.classes.show', $class) }}">{{ $class->name }}</a></li>
                                ...
                                <div class="card-body">
                                    ...
                                    <form method="POST" action="{{ route('superadmin.classes.update', $class) }}">
                                        ...
                                        <div class="form-group mt-4 pt-3 border-top text-right">
                                            <a href="{{ route('superadmin.classes.show', $class) }}" class="btn btn-secondary">
    ...
    <script>
        $(document).ready(function() {
            ...
            $('form').on('submit', function(e) {
                ...
                // Validate capacity - cannot be less than enroled
                if (capacity < currentEnrolled) {
                    swal({
                        title: "Invalid Capacity!",
                        text: "Capacity cannot be less than the current number of enroled students (" + currentEnrolled + ").\n\nPlease either:\n1. Increase the capacity, or\n2. Remove some students from this class first",
                        type: "error",
                        confirmButtonText: "OK"
                    }, function() {
                        $('#capacity').focus();
