                            ...
                            <div class="panel lobipanel-basic panel-info">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="class-actions">
                                        <a href="{{ route('superadmin.classes.show', $class) }}" class="btn btn-primary btn-sm flex-fill">
                                            <i class="ti-eye"></i> View Details
                                        </a>
                                        <a href="{{ route('superadmin.classes.edit', $class) }}" class="btn btn-success btn-sm">
