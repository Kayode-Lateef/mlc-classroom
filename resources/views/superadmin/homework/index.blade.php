                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="text-right mb-3">
                                <a href="{{ route('superadmin.homework.create') }}" class="btn btn-primary">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="filter-card">
                                <form method="GET" action="{{ route('superadmin.homework.index') }}">
                                    <div class="row">
                                        <div class="col-md-2">
                                    ...
                                    <div class="text-right">
                                        <a href="{{ route('superadmin.homework.index') }}" class="btn btn-secondary btn-sm">
                                ...
                                <div class="panel lobipanel-basic panel-info">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div style="padding: 15px; border-top: 1px solid #e9ecef;">
                                            <a href="{{ route('superadmin.homework.show', $assignment) }}" class="btn btn-primary btn-sm flex-fill">
                                                <i class="ti-eye"></i> View Details
                                            </a>
                                            <a href="{{ route('superadmin.homework.edit', $assignment) }}" class="btn btn-success btn-sm">
                                                <i class="ti-pencil-alt"></i>
                                            </a>
                                            @if($assignment->file_path)
                                            <a href="{{ route('superadmin.homework.download', $assignment) }}" class="btn btn-success btn-sm" title="Download">
