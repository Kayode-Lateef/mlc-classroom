    ...
    <div class="content-wrap">
        <div class="main">
            <div class="container-fluid">
                        ...
                        <div class="page-header">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li><a href="{{ route('superadmin.progress-sheets.show', $progressSheet) }}">Details</a></li>
                ...
                <form action="{{ route('superadmin.progress-sheets.update', $progressSheet) }}" method="POST" id="progressSheetEditForm">
                    @csrf
                    @method('PUT')
                ...
                <form id="delete-form" action="{{ route('superadmin.progress-sheets.destroy', $progressSheet) }}" method="POST" style="display: none;">
                    @csrf
                    @method('DELETE')
                </form>
...
$(document).ready(function() {
    ...
    function loadStudents(classId) {
        $.ajax({
            url: '{{ route("superadmin.progress-sheets.get-students") }}',
            method: 'GET',
