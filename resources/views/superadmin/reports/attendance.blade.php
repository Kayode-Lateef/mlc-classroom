                        ...
                        <div class="card alert">
                            <div class="card-header">
                                ...
                                <div class="card-header-right">
                                    <!-- PDF Export -->
                                    <form method="POST" action="{{ route('superadmin.reports.export') }}" style="display: inline-block; margin-right: 5px;">
                                        @csrf
                                    ...
                                    <!-- CSV Export -->
                                    <form method="POST" action="{{ route('superadmin.reports.export') }}" style="display: inline-block;">
                                        @csrf
                                        <input type="hidden" name="report_type" value="attendance">
