                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="mb-3 text-right">
                                <a href="{{ route('superadmin.schedules.edit', $schedule) }}" class="btn btn-primary">
                                    <i class="ti-pencil"></i> Edit Schedule
                                </a>
                                @if($schedule->attendance()->count() === 0)
                                <form action="{{ route('superadmin.schedules.destroy', $schedule) }}" method="POST" style="display: inline-block;" onsubmit="return confirm('Are you sure you want to delete this schedule?');">
                                    @csrf
                                    @method('DELETE')
                    ...
                    <div class="row">
                            ...
                            <div class="card alert">
                                <div class="card-header">
                                    ...
                                    <div class="card-header-right-icon">
                                        <a href="{{ route('superadmin.classes.show', $schedule->class) }}" class="btn btn-sm btn-primary">
                                        ...
                                        <table class="table table-hover">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{ route('superadmin.schedules.show', $otherSchedule) }}" class="btn btn-sm btn-info">
                                                            <i class="ti-eye"></i>
                                                        </a>
                                                    </td>
                                                </tr>
                        ...
                        <div class="col-lg-4">
                            ...
                            <div class="card alert">
                                ...
                                <div class="card-body">
                                    <a href="{{ route('superadmin.schedules.edit', $schedule) }}" class="btn btn-primary btn-block mb-2">
                                        <i class="ti-pencil"></i> Edit Schedule
                                    </a>
                                    <a href="{{ route('superadmin.classes.show', $schedule->class) }}" class="btn btn-info btn-block mb-2">
                                        <i class="ti-blackboard"></i> View Class
                                    </a>
                                    <a href="{{ route('superadmin.schedules.index') }}" class="btn btn-pink btn-block mb-2">
