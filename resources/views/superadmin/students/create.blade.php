                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card alert">
                                <div class="card-body">
                                    <form method="POST" action="{{ route('superadmin.students.store') }}" enctype="multipart/form-data">
                                        @csrf
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <small class="form-text text-muted">
                                                            <i class="ti-calendar"></i> Student's date of birth
                                                        </small>
                                                        @error('date_of_birth')
                                                        <span class="invalid-feedback">{{ $message }}</span>
                                                        @enderror
                                        ...
                                        <div class="info-box">
                                            <div class="d-flex">
                                                ...
                                                <div>
                                                    ...
                                                    <p class="mb-0">Please ensure all required fields are filled correctly. The parent will be notified of the new student enrollment via email.</p>
                                                </div>
                                            </div>
                                        </div>
