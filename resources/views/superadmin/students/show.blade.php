                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="action-button-group" style="margin-bottom: 20px;">
                                ...
                                <form action="{{ route('superadmin.students.destroy', $student) }}" method="POST" style="display: inline-block;" onsubmit="return confirm('Are you sure you want to delete this student? This action cannot be undone.');">
                                    @csrf
                                    @method('DELETE')
