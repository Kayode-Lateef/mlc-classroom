                            ...
                            <div class="stat-card">
                                <div style="display: flex; align-items: center;">
                                    ...
                                    <div style="margin-left: 15px; flex: 1;">
                                        <div class="stat-number text-primary">{{ $userStats['classes'] ?? 0 }}</div>
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="stat-card">
                                <div style="display: flex; align-items: center;">
                                    ...
                                    <div style="margin-left: 15px; flex: 1;">
                                        <div class="stat-number text-success">{{ $userStats['students'] ?? 0 }}</div>
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="stat-card">
                                <div style="display: flex; align-items: center;">
                                    ...
                                    <div style="margin-left: 15px; flex: 1;">
                                        <div class="stat-number text-warning">{{ $user->homeworkAssignments ? $user->homeworkAssignments->count() : 0 }}</div>
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="stat-card">
                                <div style="display: flex; align-items: center;">
                                    ...
                                    <div style="margin-left: 15px; flex: 1;">
                                        <div class="stat-number text-info">{{ $userStats['resources'] ?? 0 }}</div>
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="stat-card">
                                <div style="display: flex; align-items: center;">
                                    ...
                                    <div style="margin-left: 15px; flex: 1;">
                                        <div class="stat-number text-primary">{{ $userStats['children'] ?? 0 }}</div>
                                ...
                                <div style="display: flex; align-items: center;">
                                    ...
                                    <div style="margin-left: 15px; flex: 1;">
                                        <div class="stat-number text-success">
                                            {{ $user->children->sum(function($child) { return $child->classes->count(); }) }}
                                        </div>
