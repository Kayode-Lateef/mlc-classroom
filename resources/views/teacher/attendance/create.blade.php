                                ...
                                <div class="card-body">
                                    <form method="GET" action="{{ route('teacher.attendance.create') }}">
                                        ...
                                        <div class="alert alert-warning">
                                            ...
                                            <br>
                                            <small>Please select a different date or <a href="{{ route('teacher.schedules.create') }}">create a schedule</a> for this class.</small>
                                        </div>
                                        @endif
                                    </form>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="alert alert-info">
                                    ...
                                    <p class="mb-0">Attendance has already been marked for this session. You can <a href="{{ route('teacher.attendance.edit', [$selectedDate, $selectedClass->id, $selectedSchedule->id]) }}">edit the existing records</a> or <a href="{{ route('teacher.attendance.show', [$selectedDate, $selectedClass->id, $selectedSchedule->id]) }}">view the session</a>.</p>
                                </div>
                            </div>
                        </div>
                    @endif --}}
