    ...
    <div class="content-wrap">
        <div class="main">
            <div class="container-fluid">
                        ...
                        <div class="page-header">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li><a href="{{ route('teacher.progress-sheets.show', $progressSheet) }}">Details</a></li>
                ...
                <form action="{{ route('teacher.progress-sheets.update', $progressSheet) }}" method="POST" id="progressSheetEditForm">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-8">
                            ...
                            <div class="alert alert-warning" id="no-students-warning" style="display: none;">
                                ...
                                No students are enroled in this class. You can still update the progress sheet, but there won't be any student notes.
                            </div>
                        </div>
                            ...
                            <div class="card alert">
                                <div class="card-body">
                                    <div style="display: flex; justify-content: space-between; align-items: center;">
                                        ...
                                        <div>
                                            <a href="{{ route('teacher.progress-sheets.show', $progressSheet) }}" class="btn btn-secondary">
                ...
                <form id="delete-form" action="{{ route('teacher.progress-sheets.destroy', $progressSheet) }}" method="POST" style="display: none;">
                    @csrf
                    @method('DELETE')
                </form>
...
$(document).ready(function() {
    ...
    function loadStudents(classId) {
        $.ajax({
            url: '{{ route("teacher.progress-sheets.get-students") }}',
            method: 'GET',
