                        ...
                        <div class="filter-card">
                            <form method="GET" action="{{ route('teacher.progress-sheets.index') }}">
                                ...
                                <div class="text-right">
                                    <a href="{{ route('teacher.progress-sheets.index') }}" class="btn btn-secondary">
                        ...
                        <div class="col-lg-4 col-md-4 mb-4">
                            <div class="card progress-sheet-card p-3 h-100 d-flex flex-column justify-content-between">
                                ...
                                <div class="action-buttons" style="padding-top: 12px; border-top: 1px solid #e9ecef;">
                                    <a href="{{ route('teacher.progress-sheets.show', $sheet) }}" class="btn btn-primary btn-sm flex-fill">
                                        <i class="ti-eye"></i> View
                                    </a>
                                    <a href="{{ route('teacher.progress-sheets.edit', $sheet) }}" class="btn btn-success btn-sm">
