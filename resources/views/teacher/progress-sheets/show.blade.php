                ...
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        ...
                        <div class="card alert">
                            ...
                            <div class="card-body">
                                <a href="{{ route('teacher.progress-sheets.edit', $progressSheet) }}" class="btn btn-primary btn-block mb-2">
                                    <i class="ti-pencil-alt"></i> Edit Progress Sheet
                                </a>

                                <form action="{{ route('teacher.progress-sheets.destroy', $progressSheet) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this progress sheet? This action cannot be undone.');">
                                    @csrf
                                    @method('DELETE')
