                    ...
                    <div class="row">
                            ...
                            <div class="card alert">
                                ...
                                <div class="resource-header">
                                    <div style="display: flex; justify-content: space-between; align-items: start;">
                                        ...
                                        <a href="{{ route('teacher.resources.edit', $resource) }}" class="btn btn-primary btn-sm">
                        ...
                        <div class="col-lg-4">
                            ...
                            <div class="card alert">
                                ...
                                <div class="card-body">
                                    <a href="{{ route('teacher.resources.edit', $resource) }}" class="btn btn-primary btn-block mb-2">
                                        <i class="ti-pencil-alt"></i> Edit Resource
                                    </a>
                                    
                                    @if($resource->resource_type !== 'video' && $resource->resource_type !== 'link')
                                    <a href="{{ route('teacher.resources.download', $resource) }}" class="btn btn-success btn-block mb-2">
